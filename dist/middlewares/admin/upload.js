...
exports.uploadSingleFile = exports.uploadMultipleFile = exports.upload = void 0;
...
const uploadMultipleFile = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        if (!req["files"]) {
            return next();
        }
        for (const key in req["files"]) {
            ...
            req.body[key] = yield uploadToCloudinary(file.buffer);
        }
        next();
    }
    catch (error) {
