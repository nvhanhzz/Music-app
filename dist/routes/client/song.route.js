...
const validate = __importStar(require("../../validate/client/song.validate"));
...
router.get("/favorite", auth_1.isLoggedIn, controller.getFavoriteSong);
...
router.patch("/like", auth_1.isLoggedIn, validate.validatePatchLike, controller.patchLike);
